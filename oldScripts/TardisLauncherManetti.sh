...
TARDIS_HOME_PATH=/dev/hd2/tardisFolderManetti/tardis_AleFork
Z3_PATH=/dev/hd2/usr/opt/z3/z3-4.8.9-x64-ubuntu-16.04/bin/z3
REPO_HOME_PATH=/dev/hd2/tardisFolderManetti/TARDISBenchmarks-junitcontest
GRADLE_REPO_PATH=/dev/hd2/usr/.gradle
LOG_PATH=/dev/hd2/tardisFolderManetti/tardisLogs
